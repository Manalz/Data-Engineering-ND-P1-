...
3. Insert the previous extracted attributes into time_table_insert table.
4. Insert userId, firstName, lastName, gender, level into user_table_insert table.
5. Insert songplay records into songplay_table_insert table that are given by song_select.
